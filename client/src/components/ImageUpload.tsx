...
const ImageUpload: React.FC<ImageUploadProps> = ({ 
  ...
  return (
    <div className={`image-upload ${className}`}>
      {!previewUrl ? (
        <div
          className={`upload-area border-2 border-dashed rounded-lg p-6 text-center transition-colors duration-200 ${
            dragActive 
        ...
        >
          ...
          <div className="upload-content">
            ...
            <button
              ...
              disabled={isAnalyzing}
              className="upload-button bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/50 rounded-lg px-4 py-2 text-purple-200 text-sm transition-colors duration-200 disabled:opacity-50"
            >
        ...
        <div className="image-preview bg-black/30 border border-purple-500/50 rounded-lg p-4">
          ...
          <div className="image-container mb-4">
            <img
              ...
              className="max-w-full max-h-64 rounded-lg mx-auto block"
            />
          </div>

          {isAnalyzing && (
            <div className="analyzing text-center py-4">
          ...
          {currentAnalysis && !isAnalyzing && (
            <div className="analysis-results space-y-3">
              <div className="ghost-reaction bg-purple-900/20 rounded-lg p-3">
                <div className="text-purple-200 text-sm font-medium mb-2">Ghost's Reaction:</div>
                <div className="text-purple-100 text-sm italic">
                  "{currentAnalysis.ghostReaction}"
                </div>
              </div>

              <div className="analysis-mood flex items-center space-x-4">
                <div className="mood-info">
                  <span className="text-purple-300 text-xs">Detected Mood:</span>
                  <span className="text-purple-100 text-sm ml-2 capitalize">
              ...
              {currentAnalysis.suggestions.length > 0 && (
                <div className="conversation-suggestions">
                  <div className="text-purple-300 text-xs mb-2">The ghost suggests discussing:</div>
              ...
              <div className="emotional-context bg-purple-900/10 rounded p-2">
